...
if [[ -z "${GITHUB_TOKEN:-}" ]]; then
  ...
  echo "2. Generate new token (classic) with 'repo' + 'workflow' scopes"
  echo "   (fine-grained: Contents + Workflows = Read and write — repo has .github/workflows/)"
  echo "3. Run:"
...
# x-access-token works for classic and fine-grained PATs (not stored in git config)
AUTH_URL="https://x-access-token:${GITHUB_TOKEN}@github.com/t-shaik1dadapeer-tech/Eval-AI-Agent.git"
